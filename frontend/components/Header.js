  ...
  return (
    <header className="fixed top-0 w-full clearNav z-50">
      <div className="max-w-5xl mx-auto flex flex-wrap p-5 flex-col md:flex-row">
        ...
        >
          <div className="md:mr-auto font-4 pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-start justify-items-start">
            <a className="md:mr-auto ml-auto pl-2 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              Templates
            </a>
          ...
          <a
              className="rounded-lg items-center pl-7 py-2 font-semibold tracking-tighter text-white transition duration-500 ease-in-out transform bg-transparent bg-gradient-to-r from-blue-500 to-blue-800 px-14 text-md md:mt-0 focus:shadow-outline"
              href="/"
            >
